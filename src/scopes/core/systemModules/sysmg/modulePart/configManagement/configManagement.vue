...
<script>
  ...
  const columns = [
    { title: '字段名', dataIndex: 'fieldName',overflowTooltip: true, width: '26%', scopedSlots: { customRender: 'fieldName' } },
  ...
  { title: '操作人', dataIndex: 'opUsername', width: '14%', overflowTooltip: true, scopedSlots: { customRender: 'opUsername' } },
  { title: '操作', align: 'center', width: 120, scopedSlots: { customRender: 'action' } }
]
...
export default {
  ...
  data () {
    return {
      ...
      functionType: '2',
      configCategoryType: 'CONFIGFUNCTIONCATEGORY',
